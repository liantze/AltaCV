...
%% Use the "leftphoto" option if you also want a left picture in your cv 
 \documentclass[10pt,a4paper,normalphoto,leftphoto]{altacv}
...
%% If you have the "leftphoto" option you need to have this photoL defined, otherwise you'll have compilation errors
\photoL{2.8cm}{mmayer-wikipedia-cc-by-2_0}

% From https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Yahoo%21_%282019%29.svg/320px-Yahoo%21_%282019%29.svg.png, CC-BY 2.0
\photo{3.3cm}{320px-Yahoo!_(2019)}
